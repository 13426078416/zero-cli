import { loadModule, warn, hasProjectGit, hasGit } from "@zero-cli/cli-utils-shared";
...
import { Preset } from "@zero-cli/cli-types-shared/dist/shared";
...
class BaseCreator {
  ...
  public async resolvePlugins<T extends RawPlugin>(
    ...
    const sortedRawPlugins = sortObject(rawPlugins, ["@@zero-cli/cli-service-plugin"], true);
