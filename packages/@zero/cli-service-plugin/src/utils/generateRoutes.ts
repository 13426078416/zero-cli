...
async function getAst(sourceFile: string) {
  ...
  return result?.ast as BabelFileResult['ast'];
}

function produceOriginRoute(ast: BabelFileResult['ast']): type.Node {
...
function produceStaticRoute(ast: BabelFileResult['ast']): type.Node {
...
function produceDynamicRoute(ast: BabelFileResult['ast']): type.Program {
...
function isUseStore(ast: BabelFileResult['ast']): boolean {
  let useStore = false;
...
function getPreparerComponentPath(ast: BabelFileResult['ast']): string {
