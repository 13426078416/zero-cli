import { error, warn, Spinner, loadFile } from "@zero-cli/cli-utils-shared";
...
function requireSpecifiedConfigFile<T>(
  ...
  const configTempDir = path.resolve(context, "node_modules/@zero-cli/cli-service-plugin/temp");
